...
//        map.put(EventField.DISK_FREE, 16.0);
//        Event event = new Event(EventType.DISK, Instant.now(clock), map);
//        eventRepository.save(event);
//
//        AlertRule rule = new AlertRule("Disk4", EventType.DISK, EventField.DISK_FREE, Severity.CRITICAL, new LessThanCondition(53.0), Instant.now(clock));
//
